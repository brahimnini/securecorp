...
def create_ticket_entry(title, content, author_id):
    # TODO SECURITY: XSS stocké possible via le titre et le contenu du ticket (nécessite un échappement côté template)
...
def add_comment_to_ticket(ticket_id, content, author_id):
    # TODO SECURITY: XSS stocké possible via le contenu du commentaire (nécessite un échappement côté template)
